...
def read_metadata(metadata_path, data_type, mini_data):
    '''Read train validation metadata csv file. 
    ...
    # Read csv data
    assert data_type in ['train', 'validate','evaluate']
...
def read_eval_metadata(metadata_path, data_type,mini_data):
    '''Read eval metadata csv file. 
...
def calculate_feature_for_eval_audio_files(args):
    '''Calculate eval feature of audio files and write out features to a single hdf5 
    file. 
    ...
    meta_dict = read_eval_metadata(metadata_path, data_type, mini_data)
...
if __name__ == '__main__':
    ...
    parser_scalar.add_argument('--data_type', type=str, choices=['train','evaluate'], required=True)
    ...
    if args.mode == 'calculate_feature_for_all_audio_files':
        ...
        #python features.py calculate_feature_for_all_audio_files --dataset_dir data --data_type evaluate --workspace workspace 